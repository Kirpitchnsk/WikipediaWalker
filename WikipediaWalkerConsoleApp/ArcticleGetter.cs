...
{
    class ArcticleGetter
    {
        private static Dictionary<string, List<string>> articleLinks;
        private static string dictancesBetweenArticles = "links.txt";
        public ArcticleGetter()
        {
        ...
        private static Dictionary<string, List<string>> ReadArticleLinks()
        {
            ...
            {
                Console.WriteLine($"Ошибка чтения файла {dictancesBetweenArticles}: {ex.Message}");
            }
